...
# Empennage sizing #
Cvt = 0.05*.95  # Verticle tail volume coefficient from Raymer table 6.4 + End plate effect
...
gam_h = 16  # Sweep angle of horizantle stabilizer in degrees
S_h =  94.00000   # Surface area of horizantle tail in ft^2
S_w =   826.13454   # Surface area of wing in ft^2
Svt = (Cvt * bw * S_w) / Lvt  # Planform area of vertical tail
Sht = (Cht * cw * S_w) / Lht  # Planform area of horizantle tail\

print("Sht = {} ft2".format(Sht))
print("Svt = {} ft2".format(Svt))
...
Lf =   80     # Fuselage length
Wf =   8.75     # Maximum width of fuselage
Lh =    39    # Distance from CG back to tail
Xcg =  0     # Aircraft center of gravity
X25mac =  1  # Not too sure what this term means, maybe something related to aerodynamic center
