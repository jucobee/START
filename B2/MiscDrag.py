...
def miscDrag(M, flight_stg):
    Sref = 826# Reference area
    u = 0.08238  # radians  # Upsweep angle in radians of aft section of fuselage
    Amax = 63.62 # Maximum cross sectional area of fuselage
    Abase = 400 # Total area of all places where the aft fuselage angle to the freestream exceeds 20 degrees. See Raymer pg. 288 for clarification
    if flight_stg == 1:
        D_gear = 0
