...
print((0.016 * ((Nz * Wdg)**0.414)) * (q**0.168) * (Sht**0.896)* (((100 * tch) / np.cos(Gammaht))**-0.12))
...
Lt = 31.71   # Tail length; wing quarter-MAC to tail quarter-MAC, ft
L = 79   # Fuselage structural length, ft
D = 9    # Fuselage structural depth, ft
